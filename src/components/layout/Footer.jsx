      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8">
        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="mb-4 text-xs font-medium tracking-[0.2em] uppercase text-white/70">
              Navegación
            </h4>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="mt-5 flex gap-4">
              <a
                ...
                className="text-white/30 transition-colors duration-300 hover:text-gold"
        ...
        <div className="mt-6 grid gap-4 text-center md:grid-cols-3">
          <p className="text-[11px] tracking-wider md:text-left">
            &copy; {new Date().getFullYear()} Zaro Fotografía. Todos los derechos reservados.
          </p>
          <p className="text-[11px] tracking-wider">
            Desarrollado por{' '}
            <a
              href="https://www.instagram.com/cucheeta?igsh=MWxkY3pzdHQ4dTU0bA%3D%3D"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="flex justify-center md:justify-end">
            <button
              onClick={scrollToTop}
              className="group flex items-center gap-2 text-[11px] tracking-wider transition-colors duration-300 hover:text-gold"
            >
              Volver arriba
              <svg
